---
title: 'Fix Stack-Size limit error of a recursive function using iteration'
createdAt: 2023-11-14
thumbnail: /thumbnails/abstract.jpeg
subtitle: Recursive who?
shortDescription: >
  Explore an alternative approach in walking through a deep object tree using iteration instead of recursion.
---
...
By the end of this article <Highlight color="blue">you will learn how to avoid this situation by converting a recursive function into its iterative counterpart</Highlight>.
...
The concept for the iterative approach is simple, <Highlight color="blue">it uses a stack or queue to sequentially process elements of a data structure without recursion</Highlight>.
