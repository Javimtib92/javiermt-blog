...
The concept for the iterative approach is simple, <Highlight color="red">it uses a stack or queue to sequentially process elements of a data structure without recursion</Highlight>.
