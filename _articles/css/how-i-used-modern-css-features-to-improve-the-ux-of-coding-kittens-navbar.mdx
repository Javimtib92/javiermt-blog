...
As I mentioned at the begining of this post, `animation-timeline` is not supported in all browsers. In fact as of January 2024 this is only supported in Chromium browsers and on Firefox under an experimental flag.
