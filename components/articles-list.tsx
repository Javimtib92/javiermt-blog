...
async function ArticleItem({
    ...
    return (
        <article className="flex px-0 py-7">
            <Link href={article.path} className="mr-6 block flex-[0_0_100px] sm:flex-[0_0_180px] lg:flex-[0_0_240px]">
                <Image
            ...
            <div className="relative flex flex-col justify-between max-lg:flex-1">
                <header>
                    <h3 className="mb-2 ml-0 mr-10 mt-2 italic leading-5">{articleData.subtitle}</h3>

                    <h2 className="w-[90%] font-roboto text-[26px] leading-7">{articleData.title}</h2>
                </header>
                <div className="max-w-[80%] font-lora leading-6 max-sm:hidden">
